...
const router = createRouter({
  ...
  routes: [
    { path: "/", redirect: "/aba" },
    { path: "/aba", name: "dashboard", component: DashboardView },
    { path: "/edit", name: "dashboard-edit", component: DashboardEditView },
    { path: "/competitors", name: "competitors", component: CompetitorView },
    { path: "/competitors/report", name: "competitor-report", component: CompetitorReportView },
    { path: "/weighted-blankets/pounds", name: "weighted-blankets-pounds", component: WeightedBlanketsPoundsView },
  ],
});
